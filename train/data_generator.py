...
class DataGenerator:
    ...
    def generate_data(self):
        ...
        self.logger.append_log("{} has data for {} to {}".format(self.data_path, self.batch_start_date,
                                                                 self.df.tail(1).iloc[0]['timestamp']))
        print("In final Stock data")
        print(self.df.shape)
        
        self.df.to_csv('./outputs/df_AAPL.csv',index=False)
    ...
    def create_features(self):
        ...
        print("inside create_features before calculate")
        print(df.shape)
        
        self.calculate_technical_indicators(df, 'close', intervals)
        print("inside create_features after calculate")
        print(df.shape)
        ...
        print("inside create_features before if condition")
        print(df.shape)
        ...
        print("inside create_features final calculate")
        print(df.shape)
